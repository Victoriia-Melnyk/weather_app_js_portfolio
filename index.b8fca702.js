...
/* global alert */ var _weatherApi = require("./weatherApi");
...
function changeTemperatureToCelcius(e) {
    ...
    currentTemperature.innerHTML = `${Math.round((currentTempInFarenh - 32) / 1.8)}`;
...
function updateForecastWeather(forecastResponse) {
    for(let i = 1; i <= 5; i++){
        ...
        forecastMaxTemp.innerHTML = `${Math.round(forecastDayData.temperature.maximum)}\xb0\u{421}`;
        forecastMinTemp.innerHTML = `${Math.round(forecastDayData.temperature.minimum)}\xb0\u{421}`;
    }
}
async function changeWeatherDataByCity(e) {
    ...
    try {
        const response = await (0, _weatherApi.fetchWeatherByCity)(city);
        const forecastResponse = await (0, _weatherApi.fetchForecastByCity)(city);
...
async function changeWeatherDataByGeo(e) {
    ...
    try {
        ...
        const response = await (0, _weatherApi.fetchWeatherByGeo)(latitude, longitude);
        const forecastResponse = await (0, _weatherApi.fetchForecastByGeo)(latitude, longitude);
        updateCurrentWeather(response);
        updateForecastWeather(forecastResponse);
    } catch  {
        alert("Failed to fetch weather data. Please try again later.");
...
},{"./weatherApi":"2LFPp"}],"2LFPp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchWeatherByCity", ()=>fetchWeatherByCity);
parcelHelpers.export(exports, "fetchWeatherByGeo", ()=>fetchWeatherByGeo);
parcelHelpers.export(exports, "fetchForecastByCity", ()=>fetchForecastByCity);
parcelHelpers.export(exports, "fetchForecastByGeo", ()=>fetchForecastByGeo);
